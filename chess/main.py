...
BOARD_SIZE = HEIGHT - BAR_HEIGHT  # Kích thước của bàn cờ (không bao gồm thanh điều khiển)
SQ_SIZE = BOARD_SIZE // DIMENTION  # Kích thước của mỗi ô vuông trên bàn cờ
...
def drawText(screen, text):
    font = p.font.SysFont("Helvetica", 50, True, False)  # Định nghĩa phông chữ
